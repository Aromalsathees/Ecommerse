...
const Images = () => {
  return (
    <main>
      <div className='lg:w-full lg:px-12 mx-auto mt-10'>
        <img className='rounded-lg h-auto px-10 lg:w-full lg:h-200' src="https://assets-news.housing.com/news/wp-content/uploads/2023/02/08055421/wooden-furniture-design3.png" alt="" />
        <div className='lg:px-35 lg:mt-10 px-6 mt-5'>
          <h1>
          ...
          <div className='grid grid-cols-2 gap-6 mt-4 lg:mt-10 texy-gray-400'>
