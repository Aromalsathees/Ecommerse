...
const Carts = () => {
  return (
    ...
    <div className='max-w-6xl mx-auto px-4 mt-5 h-screen'>
      ...
      <div className='border border-gray-500 rounded-md shadow-md mt-5'>
        <div className='grid grid-cols-2 gap-5 mt-5 px-4'>
          <div>
            ...
            <p className='text-gray-500 font-semibold'>Quantity : 2</p>
          </div>
        ...
        <div className='flex justify-between mt-4 border-t border-gray-500 w-full'>
          ...
          <button className='text-gray-500 font-semibold w-20 p-2 rounded-full flex gap-2'><span class="material-symbols-outlined">add_shopping_cart</span>Buy</button>
        </div>
      </div>
